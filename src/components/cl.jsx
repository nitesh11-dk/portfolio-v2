...
Command: npx gltfjsx@6.5.3 public/models/cl.glb -o src/components/cl.jsx -r public 
...
export function Cl(props) {
  const { nodes, materials } = useGLTF('/models/cl.glb')
  return (
