...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen w-full  flex flex-col relative" id="home">
      <div className="w-full z-10 mx-auto mt-40 flex flex-col sm:mt-36  c-space gap-3">
        <p className="sm:text-3xl text-xl font-medium text-white text-center font-generalsans">
          Hi, I am Nitesh <span className="waving-hand">👋</span>
        </p>
        <p className="hero_tag text-zinc-100 md:text-zinc-200">Building Brands, Developing Web</p>
      </div>
